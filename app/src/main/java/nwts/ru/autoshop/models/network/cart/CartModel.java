...
public class CartModel {
    ...
    @Generated(hash = 1850756932)
    private transient CartModelDao myDao;

    public CartModel(int cart_ID, int user_ID, int cartTovarCount, double cartSumma,
    ...
    @Generated(hash = 1945966134)
    public CartModel() {
    }


    @Generated(hash = 1605055320)
    public CartModel(Long id, int Cart_ID, int User_ID, int CartTovarCount, double CartSumma,
            int TC_ID, int Tovar_ID, int Tovar_Count, double Price, double Summa,
            String Menu_name, int Category_ID, String Menu_image, int SubCategory_ID,
    ...
    @Generated(hash = 561163212)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getCartModelDao() : null;
    }
}
